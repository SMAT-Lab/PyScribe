#coding=utf-8
'''
本库以numpy和pandas为基本数据结构，通过计算混淆矩阵，并以此为基础，计算相关评价标准
不了解混下矩阵的参考：https://blog.csdn.net/joeland209/article/details/71078935
...
def get_eval_ex(true_labels, pred_labels,unique_labels=None, is_weight=False):
    ...
    :return:
    '''
    logging.info('Get an integrated example of evaluation results')
